<?php include('partials-front/header.php'); ?>
    ...
    <section class="ftco-section ftco-no-pb ftco-no-pt bg-light">
			<div class="container">
				<div class="row">
					<div class="col-md-5 p-md-5 img img-2 d-flex justify-content-center align-items-center" style="background-image: url(https://cdn.brvn.vn/news/480px/2019/18842_6017_pcnd.jpg);">
						<a href="https://www.youtube.com/watch?v=Th3iqfNaov4" class="icon popup-vimeo d-flex justify-content-center align-items-center">
	          ...
	          <div class="heading-section-bold mb-4 mt-md-5">
	          	<div class="ml-md-0">
		            <h2 class="mb-4">Thành lập vào năm 2023.</h2>
	            </div>
	          </div>
	          <div class="pb-md-5 pb-4">
							<p>Chuyên cung cấp các mặt hàng điện tử chính hãng, mẫu mã đẹp và hot nhất trên thị trường với giá cả phù hợp tới người tiêu dùng.
              <br>
    ...
    <section class="ftco-gallery">
    	<div class="container">
            ...
            <p>Shop bán hàng điện tử chính hãng chất lượng trên cả tuyệt vời. Hãy theo dõi chúng tôi để có thể trải nghiệm những sản phẩm mới nhất thị trường.</p>
          </div>
    		</div>
    	</div>
