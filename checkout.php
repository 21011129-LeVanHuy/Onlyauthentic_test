          ...
          <div class="col-xl-10 ftco-animate">
                ...
                <div class="w-100"></div>
		            ...
		            <div class="col-md-6">
	                  ...
	                  <input type="text" class="form-control" name="address" value="<?php if(isset($_SESSION['user'])){
						// echo $address; 
						}?>">
	                </div>
		            </div>
		            <div class="col-md-6">
	                  ...
	                  <input type="text" class="form-control" name="city" value="<?php if(isset($_SESSION['user'])){
						// echo $city; 
						}?>">
	                </div>
		            </div>
