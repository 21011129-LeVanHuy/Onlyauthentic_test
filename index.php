    							...
    							<div class="col-md-6">
		    						<div class="choose-wrap wrap img align-self-stretch bg-light d-flex align-items-center">
		    							<div class="text text-center px-5">
		    								<span class="subheading">Halloween sôi động</span>
				    						<h2>Giảm giá 50%</h2>
				    						<p>Tri ân khách hàng luôn đồng hành cùng Ignore Shop.</p>
				    						<p><a href="#" class="btn btn-black px-3 py-2">Mua ngay</a></p>
				    					</div>
		    						</div>
	    						</div>
	            ...
	            <h2 class="mb-3">Sản phẩm nổi bật của năm</h2>
    				...
    				<div id="timer" class="d-flex mb-4">
						...
						<div class="text-deal">
							...
							<p class="price"><span class="mr-2 price-dc">47.000.000 VNĐ</span><span class="price-sale">44.990.000 VNĐ</span></p>
