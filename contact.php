<?php include('partials-front/header.php'); ?>
    ...
    <section class="ftco-section contact-section bg-light">
      <div class="container">
          ...
          <div class="col-md-3 d-flex">
          	<div class="info bg-white p-4">
	            <p><span>Email:</span> <a href="mailto:info@yoursite.com">ignoreshop@gmail.com</a></p>
	          </div>
          </div>
          <div class="col-md-3 d-flex">
          	<div class="info bg-white p-4">
	            <p><span>Trang web:</span> <a href="#">ignoreshop.com</a></p>
	          </div>
          </div>
        </div>
